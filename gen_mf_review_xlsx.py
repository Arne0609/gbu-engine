# -*- coding: utf-8 -*-
"""Erzeugt die Klärungsliste + Regelübersicht des mehrfragigen Typs als Excel
für die fachliche Gegenlesung:  python3 gen_mf_review_xlsx.py
Eingaben: norm_81_20_mf.json, mf_klaerung.json  ->  GBU_MF_Klaerungsliste.xlsx
"""
import json, os
...
kl = json.load(open(os.path.join(HERE, 'mf_klaerung.json'), encoding='utf-8'))
OUT = os.path.join(HERE, 'GBU_MF_Klaerungsliste.xlsx')
