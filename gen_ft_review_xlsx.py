# -*- coding: utf-8 -*-
"""Erzeugt die Klärungsliste + Regelübersicht des Fahrtreppen-Typs als Excel
für die fachliche Gegenlesung:  python3 gen_ft_review_xlsx.py
Eingaben: norm_fahrtreppe.json, ft_klaerung.json  ->  GBU_Fahrtreppe_Klaerungsliste.xlsx
"""
import json, os
...
seed = json.load(open(os.path.join(HERE, 'norm_fahrtreppe.json'), encoding='utf-8'))
kl = json.load(open(os.path.join(HERE, 'ft_klaerung.json'), encoding='utf-8'))
OUT = os.path.join(HERE, 'GBU_Fahrtreppe_Klaerungsliste.xlsx')
...
lines = [
    ('Mehrfragiger GBU-Typ „EN 81-20 mehrfragig" (MF) – Klärungsliste zur fachlichen Gegenlesung', True),
    ...
    ('Quellen: Fragen, Stufen und Maßnahmen stammen aus den App-Katalogen (81-20 erweitert, Ergänzung 2026); '
     'die Zuordnung mehrerer Fragen zu einer Gefährdung, die Anlagenmerkmale als Filter und die '
     'Ortsmatrix (Zugang/Triebwerksraum/Schacht/Grube) folgen als Methode der Schindler-Analyse. '
     'Alle Texte sind eigenständig formuliert.', False),
